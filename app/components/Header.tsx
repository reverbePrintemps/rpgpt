...
export const Navbar = ({ children, className, style }: HeaderProps) => {
  ...
  return (
    <nav className="navbar bg-neutral text-neutral-content flex flex-col">
      ...
      {shouldShowBanner && (
        <div className="alert alert-warning mt-2 flex max-w-4xl mx-auto">
          <svg
          ...
          <span>
            Due to a sudden and unexpected increase in popularity for this app,
            I am unable to incur the api costs for much longer. Consider
            donating to help keep this app alive. ❤️
          </span>
          <div className="flex flex-col">
            <button className="btn btn-md " onClick={handleBannerDismiss}>
              Dismiss
            </button>
            <Link
